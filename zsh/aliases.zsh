...
# Custom
 ...
 alias boracay='cx ssh -s "[43] boracay.staging.app.firstcircle.ph" -e production ostrich'
 alias sb='gco staging-boracay'
 alias wb='gco webpack'
 alias beta='gco staging-beta'
 alias tech='gco tech_ops_release'
 alias fp='gci --fixup'
...
#  alias dpid='cat tmp/pids/server.pid'
 alias dpid='kill -9 $(lsof -i tcp:3000 -t)'
 alias ftr='nvim ~/.vimrc.after'
 alias r='bin/rails'
 alias ngrok='~/ngrok http 3000'
 alias hs='nvim ~/.hyper.js'
 alias rid='sudo lsof -i :8081'
